...
const Home = () => {
 ...
 <div>
  ...
  <div className="w-full md:w-[50%] ml-4 md:ml-0 md:mr-2">
  ...
  <div className="flex flex-col items-center w-full md:w-[50%] justify-center md:mr-4">
    <div className="flex flex-col gap-4 items-center text-center">
      ...
      <p className="w-full md:w-[60%] text-xl justify-center">
  ...
  {events?.map((value, index) => {
    return (
      <div className="flex mx-2 mb-2" key={index}>
        <Timer4 startTime={value?.startTime} eventName={value?.eventName} />
      </div>
    );
  })}
</div>
